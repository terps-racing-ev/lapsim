...
def pound_force_inches_to_newton_meters(torque_lbfin: float) -> float:
    """Convert pound-force inches to newton metres."""

    return torque_lbfin * NEWTONS_PER_POUND_FORCE * METERS_PER_INCH
...
def square_inches_to_square_meters(area_in2: float) -> float:
    """Convert square inches to square metres."""

    return area_in2 * METERS_PER_INCH**2
